package ru.practicum.categories.comments.repository;
...
public interface CommentRepository extends JpaRepository<Comment, Integer> {
    ...
    @Query("select new ru.practicum.categories.comments.model.CommentCountByEvent(com.eventId, count(com.id)) " +
            "from Comment as com " +
