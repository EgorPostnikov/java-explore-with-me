...
public class EventServiceImpl implements EventService{
    ...
    @Override
    public EventFullDto createEvent(Integer userId, ANewEventDto requestDto) {
    ...
    @Override
    public EventFullDto updateEventOfUser(Integer userId, Integer eventId, ANewEventDto newEvent) {
       ...
       // oldEvent.setParticipantLimit(newEvent.getParticipantLimit());
        ...
        return EventMapper.INSTANCE.toEventFullDto(repository.getEventsByInitiatorIdIsAndIdIs(userId,eventId));
    }
    @Override
